...
This is emergex-code. The kernel of that architecture.
...
3. **Self-evolving.** EmergeX gets better every session. Lessons persist. Skills accumulate.
...
1. **Before starting work:** Check for existing issues. Use `gh issue list --repo 8gi-foundation/emergex-code`.
...
emergex Code - open source autonomous coding agent TUI. The free on-ramp to emergex OS.
...
- **Daemon:** Fly.io Amsterdam (emergex-vessel.fly.dev)
- **License:** Apache 2.0
...
| File | Purpose |
|------|---------|
| `packages/emergex/tools.ts` | Core tool definitions |
...
- [Constitution](https://emergex.world/constitution) - Governance framework
...
| Product | Domain | Role |
|---------|--------|------|
| **emergex Code** | emergex.dev | Open source agent kernel (this repo) |
| **emergex OS** | emergexos.com | Paid product. Revenue engine. |
| **emergex** | emergex.app | Single pane of glass dashboard. |
| **emergex World** | emergex.world | Ecosystem story, docs, media. |
| **emergex Games** | emergex.games | Agent simulation playground. |
| **emergex Jr** | emergexjr.com | AI OS for neurodivergent children. Free. |
| **emergex Telegram** | t.me/eaborobot | Telegram Mini App. |
