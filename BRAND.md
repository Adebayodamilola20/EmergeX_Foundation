# emergex Brand System

Canonical brand reference for all emergex ecosystem repositories. Mutable by maintainers.
...
- Wordmark: "emergex" set in Fraunces 800 with an orange period (accent color)
...
|---------|--------|----------|-------|
| emergex OS | emergexos.com | emergexOS. | Dark |
| emergex Code | emergex.dev | emergex Code. | Dark |
| emergex | emergex.app | emergex. | Dark |
| emergex World | emergex.world | emergex. | Dark |
| emergex Games | emergex.games | emergex. | Dark |
| emergex Jr | emergexjr.com | emergex Jr. | Light/Warm |
...
- **Partner integrations** may use their own brand colors alongside emergex's
...
- **emergex Games** has an additional cyberpunk palette: neon green `#22c55e` on dark backgrounds
