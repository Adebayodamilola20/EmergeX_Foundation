# Contributing to emergex Code

Thank you for your interest in contributing to emergex Code — The Infinite Gentleman!

## Philosophy

emergex is built on a simple principle: **structure beats brute-force**.
...
```bash
npm install -g @podjamz/emergex-code
emergex
```
...
emergex-code/
├── bin/
│   └── emergex-cli.sh           # Global CLI entry point
├── apps/
