...
If you discover a security vulnerability in emergex Code, please report it responsibly.

**Do NOT open a public GitHub issue for security vulnerabilities.**

### How to Report

1. **Email:** security@emergex.dev
...
- `bin/emergex.ts` - CLI entry point
...
emergex Code is licensed under Apache 2.0. See [LICENSE](LICENSE).
