...
export const metadata: Metadata = {
  title: "emergex Brand Discovery Presentation",
...
export default function Presentation() {
  return (
    <div className="min-h-screen bg-gray-50 text-gray-900 p-8">
      <h1 className="text-4xl font-bold mb-6">emergex Brand Discovery Presentation</h1>
...
function SectionTwo() {
  return (
    <div>
      ...
      <p className="mb-4">emergex is an autonomous AI coding agent that empowers developers through local-first, agentic intelligence.</p>
    </div>
  );
}
    ...
    <div>
      ...
      <div className="bg-white rounded-lg p-6 shadow">
        ...
        <ol className="list-decimal list-inside space-y-2 mb-4">
          <li>Autonomy: We believe in giving developers complete control over their tools and data. emergex runs locally, ensuring privacy and freedom from usage caps.</li>
          <li>Craftsmanship: We take pride in elegant, efficient code and thoughtful user experiences. Every aspect of emergex is crafted with attention to detail.</li>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="bg-white rounded-lg p-6 shadow">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Desk pad: Terminal-inspired with emergex commands</li>
        ...
        <div className="bg-white rounded-lg p-6 shadow">
          ...
          <ul className="list-disc list-inside space-y-2">
            ...
            <li>Mouse pad: Terminal theme with emergex Easter eggs</li>
            <li>USB drive: Shaped like a miniature top hat</li>
            <li>Cable ties: With tiny emergex logos</li>
          </ul>
        </div>
      </div>
    </div>
    ...
    <div>
      ...
      <div className="bg-white rounded-lg p-6 shadow">
        ...
        <ol className="list-decimal list-inside space-y-2">
          <li>User launches emergex via terminal</li>
        ...
        <div className="mt-4 p-4 bg-gray-50 rounded">
          <p className="font-mono text-sm">$ emergex review codebase ./</p>
    ...
    <div>
      ...
      <div className="bg-white rounded-lg p-6 shadow">
        ...
        <ul className="list-disc list-inside space-y-2 mb-4">
          ...
          <li>emergex app store for community skills and tools</li>
        </ul>
        <div className="mt-4">
  ...
  return (
    <div>
      ...
      <div className="space-y-6">
        <div className="bg-white rounded-lg p-6 shadow">
          ...
          <ul className="list-disc list-inside space-y-1">
            ...
            <li>QR code to download emergex and claim exclusive conference skill pack</li>
          </ul>
        </div>
        <div className="bg-white rounded-lg p-6 shadow">
          ...
          <ol className="list-decimal list-inside space-y-1">
            <li>Download emergex (local-first, no registration)</li>
      ...
      <div className="mt-8 pt-6 border-t">
        ...
        <p className="mb-4">emergex is more than a tool—it's a character, a philosophy, and a movement toward developer autonomy.</p>
        <ul className="list-disc list-inside space-y-2">
