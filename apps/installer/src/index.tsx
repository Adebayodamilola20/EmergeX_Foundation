#!/usr/bin/env bun
/**
 * emergex Code - Interactive Install Wizard
 *
...
const Logo = () => (
  <Box flexDirection="column" alignItems="center" marginBottom={1}>
    <Gradient name="vice">
      <BigText text="EmergeX" font="chrome" />
    </Gradient>
...
const InstallerApp = () => {
  ...
  const saveConfig = async () => {
    const configDir = path.join(os.homedir(), ".emergex");
    ...
    <Box flexDirection="column" padding={1}>
      ...
      {step === "welcome" && (
        <Box flexDirection="column" alignItems="center">
          ...
          >
            <Text>
              Welcome to <Text color="cyan" bold>emergex Code</Text> — the free, local AI coding assistant.
            </Text>
          </Box>
          ...
          <Box flexDirection="column" marginY={1} marginLeft={2}>
            ...
            <Text>  <Text color="green">✓</Text> Configure emergex</Text>
          </Box>
      ...
      {step === "complete" && (
        <Box flexDirection="column" alignItems="center">
          ...
          <Text marginY={1}>
            emergex Code is ready. Start coding with:
          </Text>
          <Box
            borderStyle="single"
            borderColor="cyan"
            ...
            marginY={1}
          >
            <Text color="cyan">npx emergex-code</Text>
          </Box>
          <Text dimColor marginTop={1}>
            Model: <Text bold>{selectedModel}</Text>
          </Text>
          <Text dimColor>
            Config: <Text bold>~/.emergex/config.json</Text>
          </Text>
