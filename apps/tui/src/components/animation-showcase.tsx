/**
 * emergex Code - Animation Showcase
 *
...
const ANIMATIONS: AnimationInfo[] = [
  ...
  },
  {
    ...
    component: <GlitchText text="EMERGEX CODE - THE INFINITE GENTLEMAN" intensity={0.2} />,
  },
  {
    id: "confetti",
    name: "Confetti Burst",
  ...
  },
  {
    ...
    component: <GradientWave text="✦ emergex Code - The Infinite Gentleman ✦" speed={100} />,
  },
];
  ...
  return (
    <Stack borderStyle="double" borderColor="magenta" paddingX={2} paddingY={1}>
      ...
      <Box marginBottom={1} justifyContent="center">
        <GradientWave text="✦ EMERGEX ANIMATION GALLERY ✦" speed={80} />
      </Box>
...
export function MiniAnimation({ type, width = 20 }: MiniAnimationProps) {
  switch (type) {
    ...
    case "gradient":
      return <GradientWave text="emergex" speed={150} />;
    default:
      return null;
  }
}
