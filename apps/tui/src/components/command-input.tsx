/**
 * emergex Code - Animated Command Input Component
 *
 * Features:
...
const PromptIndicator = memo(({ pulse }: PromptIndicatorProps) => {
	...
	useEffect(() => {
		...
		}, 1000); // Much slower animation to reduce re-render pressure
