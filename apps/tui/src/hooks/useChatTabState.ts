/**
 * emergex Code - Per-Tab Chat State Hook
 *
 ...
 * Messages persist to ~/.emergex/tabs/chat-{tabId}.json on each update.
 */
...
const TABS_DIR = path.join(process.env.HOME || "~", ".emergex", "tabs");
