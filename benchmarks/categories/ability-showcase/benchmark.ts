...
//
// The task: Build a Session Replay Inspector for the emergex TUI.
...
export const ABILITY_SHOWCASE_BENCHMARK = {
  ...
  prompt: `# Task: Build a Session Replay Inspector for emergex TUI

You are building a Session Replay Inspector - a new screen for the emergex TUI
(Ink v6 / React for CLI) that lets users browse, replay, and analyze past
agent sessions. This is a real feature that will ship.

## Context

emergex stores session data in packages/memory/ (see types.ts for EpisodicMemory,
