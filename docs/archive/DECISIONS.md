# emergex Code - Architecture Decisions
...
## 5. Coexistence: emergex Code alongside Claude Code

**Choice:** Separate tool, coexists until it surpasses Claude Code

**Why:**
- Claude Code is battle-tested, don't break what works
- emergex Code is experimental, needs room to evolve
- Eventually emergex Code becomes the primary tool

**Paths:**
- Claude Code: `~/.claude/`
- emergex Code: `~/emergex-code/` (dev), `~/.emergex/` (runtime)
...
**Solution:** emergex Code uses AST-first retrieval, reducing token usage by 80%+
