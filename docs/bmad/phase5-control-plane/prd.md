...
The control plane is the admin/monitoring layer for emergex's multi-tenant platform. It provides visibility into platform health, user management, and billing infrastructure.
...
| Requirement | Description |
|-------------|-------------|
| Subdomain Mapping | `username.emergex.app` resolves to the user's tenant context |
...
5. As a **user**, I want my emergex instance at `myname.emergex.app` so I have a branded URL.
