...
The toolshed is the capability layer of emergex. Inspired by Stripe's agent architecture, it ensures the agent never carries knowledge or tools inside its prompt.
