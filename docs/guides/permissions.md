# emergex Code Permission System

The permission system provides security controls for command execution in emergex Code.

## Configuration

Permissions are stored in `~/.emergex/permissions.json`:
...
```typescript
import { getPermissionManager, requestCommandPermission } from "emergex-code/permissions";
