/**
 * emergex AI - Agent (AI SDK powered)
 *
 * Wraps the Vercel AI SDK ToolLoopAgent to provide the emergex agent experience.
 * Replaces the manual agentic loop in packages/emergex/agent.ts with the SDK's
...
/**
 * Create an emergex AI agent powered by the Vercel AI SDK.
 */
