/**
 * emergex AI - Package Entry Point
 *
 * Wraps the Vercel AI SDK to provide the emergex agent experience.
 * This package replaces the manual LLM client/tool loop in packages/emergex
 ...
 *   agent.ts            — ToolLoopAgent wrapper with emergex hooks
