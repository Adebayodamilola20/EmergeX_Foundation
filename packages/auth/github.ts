/**
 * @emergex/auth — GitHub Provider Token Management
 *
...
const GITHUB_KEYCHAIN_SERVICE = "emergex-github";
const GITHUB_KEYCHAIN_ACCOUNT = "emergex-cli";
const GITHUB_TOKEN_FILE = "github-token.enc";
const GITHUB_KEY_SALT = "emergex-github-v1";
...
function getFilePath(): string {
  return path.join(os.homedir(), ".emergex", GITHUB_TOKEN_FILE);
}
