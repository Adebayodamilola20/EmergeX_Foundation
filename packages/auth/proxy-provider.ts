/**
 * @emergex/auth - Control Plane Proxy Provider
 *
...
export interface ProxyConfig {
  ...
  proxyUrl: string;
  /** Bearer token from emergex.app login. */
  token: string | null;
...
const AUTH_CONFIG_PATH = path.join(os.homedir(), ".emergex", "auth-proxy.json");
...
function ensureDataDir(): void {
  const dir = path.join(os.homedir(), ".emergex");
