/**
 * @emergex/auth — Secure Token Storage
 *
 * Two implementations:
...
const KEYCHAIN_SERVICE = "emergex-auth";
const KEYCHAIN_ACCOUNT = "emergex-cli";
...
export class EncryptedFileTokenStore implements TokenStore {
  ...
  constructor(filePath?: string) {
    this.filePath =
      filePath ?? path.join(os.homedir(), ".emergex", TOKEN_FILE_NAME);
