/**
 * @emergex/auth — Type Definitions
 *
 * All auth-related types for the emergex authentication system.
...
export interface AuthConfig {
  ...
  /** Clerk frontend API URL (e.g., https://clerk.emergex.app). */
...
/** Defaults for auth config — override with env vars or .emergex/config.json. */
export const DEFAULT_AUTH_CONFIG: AuthConfig = {
  clerkPublishableKey: "",
  clerkFrontendApi: "https://clerk.emergex.app",
  oauthClientId: "",
  deviceAuthEndpoint: "https://clerk.emergex.app/v1/oauth/device/authorize",
  deviceTokenEndpoint: "https://clerk.emergex.app/v1/oauth/device/token",
