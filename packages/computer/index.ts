/**
 * emergex Code - Computer Use (Power #10)
 *
 * Desktop automation for Eight and Lil EmergeX.
 ...
 * These follow the OpenAI function-calling format used by packages/emergex/tools.ts.
 */
