/**
 * @emergex/control-plane — Stripe Webhook Route Handler
 *
 ...
 * import { createHonoWebhookHandler } from "@emergex/control-plane/stripe-webhook";
 *
 * const app = new Hono();
 ...
 * import { createExpressWebhookHandler } from "@emergex/control-plane/stripe-webhook";
 *
 * const app = express();
