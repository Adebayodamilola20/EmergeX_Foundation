 ...
 *   2. ~/.emergex/ (default local path)
 *
 * On Fly.io the volume is mounted at /root/.emergex/ and HOME=/root,
...
/**
 * Returns the root data directory for emergex persistent storage.
 * Creates the directory if it doesn't exist.
 */
export function getDataDir(): string {
  const dir = process.env.EIGHT_DATA_DIR || path.join(os.homedir(), ".emergex");
