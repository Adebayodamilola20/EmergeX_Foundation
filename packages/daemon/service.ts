...
const SERVICE_NAME = "com.emergex.daemon";
...
function generatePlist(): string {
  ...
  const logPath = `${process.env.HOME}/.emergex/daemon.log`;
  const errPath = `${process.env.HOME}/.emergex/daemon-error.log`;
...
StandardOutput=append:${process.env.HOME}/.emergex/daemon.log
StandardError=append:${process.env.HOME}/.emergex/daemon-error.log
...
async function install(): Promise<void> {
  ...
  const logDir = `${process.env.HOME}/.emergex`;
