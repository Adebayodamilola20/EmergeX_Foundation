 ...
 *
 * Persists to ~/.emergex/tasks.json on the Fly volume.
...
const TASKS_PATH = join(process.env.HOME || "/root", ".emergex", "tasks.json");
const MAX_TASKS = 100;
...
function ensureDir(): void {
  const dir = join(process.env.HOME || "/root", ".emergex");
