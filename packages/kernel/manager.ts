...
const DEFAULT_KERNEL_CONFIG: KernelConfig = {
  ...
  personalLoraPath: "~/.emergex/personal-lora/",
  production: {},
};
...
export class KernelManager {
  ...
  /**
   * Initialize from .emergex/config.json training_proxy section.
   */
  static fromProjectConfig(projectRoot: string = process.cwd()): KernelManager {
    const configPath = resolve(projectRoot, ".emergex/config.json");
