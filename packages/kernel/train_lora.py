#!/usr/bin/env python3
"""
Local LoRA training script for emergex/MetaClaw.
...
Usage:
  python3 train_lora.py \
    --data ~/.emergex/kernel/training/grpo_pairs.jsonl \
    --base-model Qwen/Qwen3-14B \
    --output ~/.emergex/checkpoints/ckpt_001 \
    --epochs 3 \
    --lora-rank 32
"""
...
def main():
    parser = argparse.ArgumentParser(description="Local LoRA trainer for emergex/MetaClaw")
    ...
    parser.add_argument("--output", default=os.path.expanduser("~/.emergex/checkpoints/latest"),
