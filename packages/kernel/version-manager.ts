...
const VERSION_FILE = path.join(os.homedir(), ".emergex", "model-version.json");
const BASELINE_FILE = path.join(os.homedir(), ".emergex", "benchmark-baseline.json");
...
const PERSONAL_LORA_DIR = path.join(os.homedir(), ".emergex", "personal-lora");
