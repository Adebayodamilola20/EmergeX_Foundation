 ...
 *   "hooks": {
 *     "SessionStart": [{
 *       "command": "bun run ~/emergex-code/packages/orchestration/mesh-hook.ts register"
 *     }],
 *     "SessionEnd": [{
 *       "command": "bun run ~/emergex-code/packages/orchestration/mesh-hook.ts deregister"
 *     }]
 *   }
 * }
 */
...
const STATE_DIR = join(homedir(), ".emergex", "mesh")
