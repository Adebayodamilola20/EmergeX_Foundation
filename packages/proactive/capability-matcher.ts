/**
 * emergex - Capability Matcher
 *
 * Evaluates whether emergex can handle a given opportunity.
...
// emergex's known strengths mapped to keywords
...
/**
 * Default capability set for emergex.
