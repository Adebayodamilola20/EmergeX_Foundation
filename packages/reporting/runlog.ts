/**
 * Run log — one line per agent run, appended to ~/.emergex/runs.jsonl
 *
...
export interface RunLogEntry {
  ...
  /** Files modified */
  modified: string[];
  /** Session ID (for cross-ref with ~/.emergex/sessions/) */
  session: string;
  /** Working directory */
  cwd: string;
...
const LOG_PATH = path.join(os.homedir(), ".emergex", "runs.jsonl");
