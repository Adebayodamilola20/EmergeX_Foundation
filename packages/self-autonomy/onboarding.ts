/**
 * emergex Code - Onboarding System
 *
 * First-run personalization. emergex learns who you are,
...
const ONBOARDING_QUESTIONS: OnboardingQuestion[] = [
  ...
  // ── Agent Personalization ────────────────────────────────
  {
    ...
    question:
      "What should your emergex be called? (default: Eight)\n\n" +
...
export class OnboardingManager {
  ...
  constructor(workingDirectory: string = process.cwd()) {
    ...
    this.userConfigPath = path.join(process.env.HOME || os.homedir(), ".emergex", "user.json");
