...
description: emergex's design philosophy and system. Apply when building any UI — TUI, web, or artifact. Design is intentional structure, not decoration.
type: skill
---
...
- Line-hemergex: 1.5-1.6 for body, tighter (1.1-1.3) for headings.
...
- **Data display**: Grid-based equal-hemergex cards, consistent gutters
