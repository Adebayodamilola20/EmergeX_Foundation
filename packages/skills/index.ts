 ...
 * 1. ~/.emergex/skills/ flat .md files (user overrides all)
...
/** Skill markdown shipped with emergex (source tree or copied next to dist/cli.js). */
...
export class SkillManager {
	...
	constructor(skillsDirectory?: string) {
		this.skillsDirectory =
			skillsDirectory || path.join(os.homedir(), ".emergex", "skills");
	}
