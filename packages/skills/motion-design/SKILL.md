---
name: motion-design
description: emergex's animation and motion rules for web and TUI. Apply when adding transitions, loading states, or interactive feedback to any interface.
type: skill
---
...
- Never animate `width`, `hemergex`, `top`, `left`, `margin`, `padding` on large elements.
