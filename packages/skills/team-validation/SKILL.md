...
description: emergex's code review and validation pattern. Use when orchestrating multi-agent workflows or reviewing code for correctness, security, and performance.
type: skill
---
