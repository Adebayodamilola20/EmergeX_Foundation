---
name: vercel-react
description: React and Next.js performance rules for emergex web tasks. Apply when writing, reviewing, or refactoring React/Next.js code.
type: skill
---
...
- Provide explicit `width` and `hemergex` to prevent layout shift.
