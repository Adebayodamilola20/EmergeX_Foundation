/**
 * @emergex/telegram-bot — GitHub Intelligence Gathering
 *
 * Nightly system that scrapes GitHub trending repos, scores relevance to emergex,
...
const HOME = homedir();
const INTEL_DIR = join(HOME, ".emergex/intelligence");
...
export class GitHubIntelligence {
    ...
    try {
      const response = await fetch(url, {
        headers: {
          ...
          "User-Agent": "emergex-intelligence/1.0",
        },
      });
  ...
  /**
   * Score a repo 1-10 for relevance to emergex-code.
   */
