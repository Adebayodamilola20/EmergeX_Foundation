/**
 * @emergex/telegram-bot — Live Dashboard
 *
...
export class LiveDashboard {
  ...
  async finish(bot: TelegramBot, finalData: DashboardData): Promise<void> {
    ...
    lines.push("├─────────────────────────┤");
    lines.push(`│ emergex: ${finalData.eightAvg.toFixed(1).padStart(5)} avg        │`);
  ...
  private formatDashboard(data: DashboardData): string {
    ...
    lines.push("├─────────────────────────┤");
    lines.push(`│ emergex:  ${data.eightAvg.toFixed(1).padStart(5)} avg       │`);
