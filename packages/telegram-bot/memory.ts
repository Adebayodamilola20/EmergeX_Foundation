/**
 * @emergex/telegram-bot — Persistent Bot Memory
 *
 * Stores conversations, repo intelligence, learnings, and arbitrary key-value data.
 * Persists to ~/.emergex/bot-memory.json with atomic writes.
 */
...
const DEFAULT_MEMORY_PATH = join(homedir(), ".emergex", "bot-memory.json");
