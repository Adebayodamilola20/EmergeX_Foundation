/**
 * @emergex/voice — Whisper Model Manager
 *
 * Downloads, lists, and selects Whisper GGML model files.
 * Models are stored in ~/.emergex/models/whisper/ by default.
 */
...
export class WhisperModelManager extends EventEmitter<ModelManagerEvents> {
  ...
  constructor(modelsPath: string = "~/.emergex/models/whisper") {
    super();
