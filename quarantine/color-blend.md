...
3. **Design systems DB** - `packages/design-systems/` can use blend modes to preview how user-supplied colors interact with the emergex palette before ingestion.
