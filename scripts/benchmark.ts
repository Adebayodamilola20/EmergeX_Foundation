...
async function runFullBenchmark(): Promise<BenchmarkSuite> {
  log("\n╔══════════════════════════════════════════════════════════════╗", colors.cyan);
  log("║  emergex Code - Benchmark Suite                                 ║", colors.cyan);
  log("║  Proving AST-first efficiency at scale                        ║", colors.cyan);
  log("╚══════════════════════════════════════════════════════════════╝\n", colors.cyan);

  const results: BenchmarkResult[] = [];

  // Benchmark: emergex's own codebase
  log("📊 Benchmark 1: emergex Code's own codebase", colors.bright);
  ...
  log("   This is why emergex Code users never hit usage caps.\n");
