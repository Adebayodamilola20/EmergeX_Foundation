#!/usr/bin/env bun
/**
 * Issue Dispatcher - Orchestrates work across local and vessel emergex instances.
 *
 * Sends GitHub issue work to emergex agents via daemon WebSocket protocol.
...
const assignments: TaskAssignment[] = [
  // --- Local Eight (14B) - focused, smaller tasks ---
  {
    ...
    target: "local",
    prompt: `You are working on GitHub issue #17 for the emergex-code project.
...
Create the fix on a branch called fix/bun-sqlite-pragma and commit your changes.`,
  },
  {
    ...
    target: "local",
    prompt: `You are working on GitHub issue #9 for the emergex-code project.
...
Create the fix on a branch called feat/memory-checkpoints and commit your changes.`,
  },
  {
    ...
    target: "local",
    prompt: `You are working on GitHub issue #8 for the emergex-code project.
...
Create on branch feat/memory-health and commit.`,
  ...
  // --- Vessel Eight (Nemotron 120B) - harder reasoning tasks ---
  {
    ...
    target: "vessel",
    prompt: `You are working on GitHub issue #7 for the emergex-code project.
...
Create on branch feat/memory-contradictions and commit.`,
  },
  {
    ...
    target: "vessel",
    prompt: `You are working on GitHub issue #21 for the emergex-code project.
...
async function main() {
  console.log("emergex Issue Dispatcher");
  console.log("=".repeat(70));
