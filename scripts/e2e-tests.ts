...
const tests: TestCase[] = [
  // 1. File creation (write_file)
  {
    ...
    prompt: "Create a file called hello.txt containing the text 'Hello from emergex'. Use write_file.",
    validate: (r) => {
...
async function runTests(): Promise<void> {
  ...
  console.log("emergex E2E Test Suite");
  ...
  const outPath = path.join(os.homedir(), ".emergex", "e2e-results.json");
