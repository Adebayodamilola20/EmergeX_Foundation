#!/usr/bin/env bun
/**
 * Generate 4 variations of the emergex.world landing page using eight:latest
...
const WORLD_DIR = join(import.meta.dir, "../../emergex-world");
...
PAGE CONTENT (emergex Code landing page):
1. Nav: logo "emergex.", links: Code, Benchmarks, Docs, GitHub
...
5. Why emergex: 4 feature cards (stop paying for tokens, keep code private, fewer broken changes, use any model)
...
async function main() {
  console.log("=== emergex Landing Page Variation Generator ===");
