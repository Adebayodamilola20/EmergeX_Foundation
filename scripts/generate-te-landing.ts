#!/usr/bin/env bun
/**
 * Generate a Teenage Engineering-inspired landing page for emergex One
...
const OUTPUT = join(import.meta.dir, "../benchmarks/ui-samples/emergex-one-landing.html");
...
PAGE STRUCTURE:
1. Nav bar - logo "emergex" (monospace), minimal links: Specs, Software, Waitlist
...
5. Software section - "Runs emergex Code" with terminal-style code block showing interaction
...
console.log("Generating emergex One landing page with eight:latest...");
